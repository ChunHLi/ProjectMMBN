...
class Protoman {
  ...
  void move(Panel[][] Grid, Megaman megaman) {
      if (numMove > 0) {
        ...
        attack(attackType, megaman, Grid);
        currentlyMoving = true;
      }
    }
      ...
      if (type == 0 || type == 1 || type == 2) {
        if (attack.currentFrame < attack.spriteCount - 1) {
          if (attackStartDelay > 0) {
            ...
            attack.display(Grid[panelRow][panelCol].getLocationX(), Grid[panelRow][panelCol].getLocationY(), invincTimer);
          }
  ...
  void hurt(Panel[][] Grid) {
    if (Grid[panelRow][panelCol].isDangerVirus() && invincTimer == 0) {
      ...
      hurt.display(Grid[panelRow][panelCol].getLocationX() - 20, Grid[panelRow][panelCol].getLocationY() - stand.height + 5, invincTimer);
    }
